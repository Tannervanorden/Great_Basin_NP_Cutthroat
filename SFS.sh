...
#~/nobackup/archive/01.RawData/Cutt_results/ngsLD/LD_Results/Pruned_mafs/Original_LDPruned_snps.list -P 4 Hendrys.saf.idx  -P 4 > HendrysO.sfs
...
#~/nobackup/archive/01.RawData/Cutt_results/SFS/angsd/misc/realSFS Historical_Strawberry.saf.idx -sites ~/nobackup/archive/01.RawData/Cutt_results/ngsLD/LD_Results/Pruned_mafs/Original_LDPruned_snps.list -P 4 > Historical_Strawberry.sfs
...
#~/nobackup/archive/01.RawData/Cutt_results/SFS/angsd/misc/realSFS saf2theta Historical_Strawberry.saf.idx -sfs Historical_Strawberry.sfs -P 4 -outname Historical_Srawberry_updated
...
~/nobackup/archive/01.RawData/Cutt_results/SFS/angsd/misc/thetaStat do_stat Historical_Srawberry_updated.thetas.idx -win 10000 -step 1000 -outnames Historical_Strawberry_updated.thetas.windows.gz
...
# ~/nobackup/archive/01.RawData/Cutt_results/SFS/angsd/misc/./thetaStat do_stat -win 10000 -step 1000 -outnames Historical_Hendrys.thetas.windows.gz
# ~/nobackup/archive/01.RawData/Cutt_results/SFS/angsd/misc/./thetaStat do_stat Historical_Strawberry.saf.idx  -win 10000 -step 1000 -outnames Historical_Strawberry.thetas.windows.gz
